...
train <- read.csv("Desktop/numerai_datasets/numerai_training_data.csv", head=T)
test <- read.csv("Desktop/numerai_datasets/numerai_tournament_data.csv", head=T)
...
write.csv(pred, file="Desktop/numerai_datasets/linear_predictions.csv", quote=F, row.names=F)
